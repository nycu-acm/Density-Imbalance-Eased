...
def parser():
    ...
    parser.add_argument('--reload_model_path', type=str, default="./weight/PUGAN_network.pth", help='optional reload model path')
    ...
    parser.add_argument('--data-pu1k',
                    default = "./dataset/data/pu1k_poisson_256_poisson_1024_pc_2500_patch50_addpugan.h5",
                    type=str,
                    metavar='PATH',
                    help='data folder (default: none)')
    parser.add_argument('--data-pugan',
                    default = "./dataset/data/PUGAN/PUGAN_poisson_256_poisson_1024.h5",
                    type=str,
                    metavar='PATH',
                    help='data folder (default: none)')
