...
def parser():
    ...
    parser.add_argument('--batch_size_test', type=int, default=1, help='input batch size')
    ...
    # parser.add_argument('--lr_decay_3', type=int, default=145, help='learning rate decay 3')
    # parser.add_argument('--lr_decay_4', type=int, default=150, help='learning rate decay 4')
    parser.add_argument('--lr_decay_1', type=int, default=110, help='learning rate decay 1')
    parser.add_argument('--lr_decay_2', type=int, default=120, help='learning rate decay 2')
    parser.add_argument('--lr_decay_3', type=int, default=130, help='learning rate decay 3')
    parser.add_argument('--lr_decay_4', type=int, default=140, help='learning rate decay 4')
    # parser.add_argument('--lr_decay_4', type=int, default=130, help='learning rate decay 4')
    ...
    parser.add_argument('--number_points', type=int, default=36, help='Number of point sampled on the object during training, and generated by atlasnet')
    parser.add_argument('--number_points_eval', type=int, default=36,
                        help='Number of points generated by atlasnet (rounded to the nearest squared number) ')
    parser.add_argument('--radius', type=int, default=0.5, help='radius of the grouping')
    parser.add_argument('--nsample', type=int, default=32, help='grouping number of points in a ball (ground truth)')
    parser.add_argument("--create_depth", action="store_true", help="create depth map or not")
    ...
    parser.add_argument('--reload_model_path', type=str, default="./weight/CARLA_network.pth", help='optional reload model path')
 
    parser.add_argument('--data-folder',
                    default='/mnt/5698b0ac-54a8-49e2-b934-ab1d9680a189/data/russell/self-supervised-depth-completion/data',
                    type=str,
                    metavar='PATH',
                    help='data folder (default: none)')
    parser.add_argument('--data-pu1k',
                    default = "./dataset/data/PU-GCN/pu1k_poisson_256_poisson_1024_pc_2500_patch50_addpugan.h5",
                    type=str,
                    metavar='PATH',
                    help='data folder (default: none)')
    parser.add_argument('--data-carla',
                    default = "./dataset/data/carla_poisson_256_poisson_1024_pc_2500_patch50.h5",
                    type=str,
                    metavar='PATH',
                    help='data folder (default: none)')
