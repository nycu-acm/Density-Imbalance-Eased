...
class Normalization(Operation):
    ...
    def normalize_unitL2ball(self):
        ...
        # ouput : torch Tensor N_pts, D_dim
        #
        self.points, centroid = self.center_pointcloud()
        ...
        return self.points, scaling_factor, centroid
    
    def normalize_self(self, centroid, scaling_factor):
        self.translate(-centroid)
        self.scale(1.0 / scaling_factor)
        return self.points
    
    def normalize_unitL2ball_self(points, centroid, scaling_factor):
        operator = Normalization(points, inplace=False)
        return operator.normalize_self(centroid, scaling_factor)
