...
class KittiDataset(torch_data.Dataset):
    def __init__(self, root_dir, split='train', mode='TRAIN'):
        ...
        self.sample_id_list = self.sample_id_list[1900:]
        self.num_sample = self.sample_id_list.__len__()

        self.npoints = 16384

        self.image_dir = os.path.join(self.imageset_dir, 'image_2')
        self.lidar_dir = os.path.join(self.imageset_dir, 'velodyne_original')
...
####################################################################################################################
        ...
        # ret_pts_intensity = pts_intensity - 0.5  # translate intensity to [-0.5, 0.5]
        ...
        #     pts_input = np.concatenate((ret_pts_rect, ret_pts_features), axis=1)  # (N, C)
        # else:
        # print(ret_pts_rect.shape)
        # ret_pts_rect[:,[0,1,2]] = ret_pts_rect[:,[2,1,0]]
        pts_input = ret_pts_rect
        ...
        sample_info['points'] = pts_input
        sample_info['target'] = pts_input
